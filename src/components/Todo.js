...
import { colorSelected, deleted, toggled } from "../redux/todos/actions/actions";
...
const Todo = ({ todo }) => {
    ...
    return (
        <div class="flex justify-start items-center p-2 hover:bg-gray-100 hover:transition-all space-x-4 border-b border-gray-400/20 last:border-0">
            ...
            <img
                src="https://raw.githubusercontent.com/Learn-with-Sumit/think-in-a-redux-way/3.1/html_template/images/cancel.png"
